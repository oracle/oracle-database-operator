...
func WaitUntilWorkCompleted(ctx context.Context, workClient workrequests.WorkRequestClient, opcWorkRequestID *string) error {
	...
	if _, err := workClient.GetWorkRequest(ctx, workRequest); err != nil {
		return err
	}
