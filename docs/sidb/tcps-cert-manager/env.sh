...
PRIMARY_DNS_NAMES="${PRIMARY_DNS_NAMES:-${PRIMARY_DNS},orcl-production,orcl-production.${NS}.svc.cluster.local}"
...
STANDBY_DNS_NAMES="${STANDBY_DNS_NAMES:-${STANDBY_DNS},truecache-production,truecache-production.${NS}.svc.cluster.local}"
