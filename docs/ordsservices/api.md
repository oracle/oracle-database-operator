...
<table>
    ...
    <tbody><tr>
      ...
      <tr>
        <td><b>poolProbes</b></td>
        <td>[]PoolProbeStatus</td>
        <td>Contains the latest probe result for each configured pool.</td>
        <td>false</td>
      </tr>
      <tr>
        <td><b>poolsHealth</b></td>
        <td>string</td>
        <td>Indicates the overall health of the configured pools, based on the latest probe results.</td>
        <td>false</td>
      </tr>
      <tr>
        <td><b>poolsValid</b></td>
        <td>string</td>
        <td>Reports how many pools are currently healthy, in the format "ok/total".</td>
        <td>false</td>
      </tr>
      <tr>
        <td><b>status</b></td>
