...
- [PrivateAI Container using OCI Public LoadBalancer](./deploy_privateai_publiclb.md) 
  - [Change the PrivateAI Container Image](./change_privateai_container_image.md) 
- [PrivateAI Container using OCI Public LoadBalancer without configmap](./deploy_privateai_publiclb_without_configmap.md) 
- [PrivateAI Container using OCI Public LoadBalancer with multiple replica](./deploy_privateai_publiclb_multi_replica.md) 
  - [Scale-out](./scale_up_privateai.md)
  - [Scale-in](./scale_in_privateai.md)
- [PrivateAI Container using OCI Public LoadBalancer with worker node selection](./deploy_privateai_publiclb_worker_node.md) 
- [PrivateAI Container using OCI Public LoadBalancer with memory and cpu limits for pods](./deploy_privateai_publiclb_mem_cpu_limit.md) 
