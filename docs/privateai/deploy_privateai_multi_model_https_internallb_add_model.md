...
2. Wait for a few minutes. You should see the configmap updated inside the Pod. You can verify that using the file `/privateai/config/config.json` inside the Pod.
