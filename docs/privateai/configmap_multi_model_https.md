...
If multiple models are available and the model files are accessible through an HTTPS URLs, then the administrator can specify the URLs in the models section of `config.json`.
