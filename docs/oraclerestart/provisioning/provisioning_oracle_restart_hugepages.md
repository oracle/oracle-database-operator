...
*	The example uses the file [oraclerestart_prov_hugepages.yaml](./oraclerestart_prov_hugepages.yaml) to provision an Oracle Restart Database with Oracle Restart Controller, featuring:
