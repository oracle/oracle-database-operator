...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DbcsSystemWebhook) DeepCopyInto(out *DbcsSystemWebhook) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DbcsSystemWebhook.
func (in *DbcsSystemWebhook) DeepCopy() *DbcsSystemWebhook {
	if in == nil {
		return nil
	}
	out := new(DbcsSystemWebhook)
	in.DeepCopyInto(out)
	return out
}
