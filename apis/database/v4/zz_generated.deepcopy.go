...
func (in *DataguardBrokerSpec) DeepCopyInto(out *DataguardBrokerSpec) {
	*out = *in
	...
	if in.ExternalDatabaseConnectStrings != nil {
		in, out := &in.ExternalDatabaseConnectStrings, &out.ExternalDatabaseConnectStrings
		*out = make([]DbConnectString, len(*in))
		copy(*out, *in)
	}
	out.ExternalAdminPassword = in.ExternalAdminPassword
}
...
func (in *DataguardBrokerStatus) DeepCopyInto(out *DataguardBrokerStatus) {
	*out = *in
	...
	if in.ExternalDgMapping != nil {
		in, out := &in.ExternalDgMapping, &out.ExternalDgMapping
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DbConnectString) DeepCopyInto(out *DbConnectString) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DbConnectString.
func (in *DbConnectString) DeepCopy() *DbConnectString {
	if in == nil {
		return nil
	}
	out := new(DbConnectString)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SingleInstanceDatabaseExternalPrimaryRef) DeepCopyInto(out *SingleInstanceDatabaseExternalPrimaryRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleInstanceDatabaseExternalPrimaryRef.
func (in *SingleInstanceDatabaseExternalPrimaryRef) DeepCopy() *SingleInstanceDatabaseExternalPrimaryRef {
	if in == nil {
		return nil
	}
	out := new(SingleInstanceDatabaseExternalPrimaryRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SingleInstanceDatabaseSpec) DeepCopyInto(out *SingleInstanceDatabaseSpec) {
	*out = *in
	...
	if in.StandbyConfig != nil {
		in, out := &in.StandbyConfig, &out.StandbyConfig
		*out = new(SingleInstanceDatabaseStandbyConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.ExternalPrimaryDatabaseRef != nil {
		in, out := &in.ExternalPrimaryDatabaseRef, &out.ExternalPrimaryDatabaseRef
		*out = new(SingleInstanceDatabaseExternalPrimaryRef)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SingleInstanceDatabaseStandbyConfig) DeepCopyInto(out *SingleInstanceDatabaseStandbyConfig) {
	*out = *in
	if in.PrimaryDetails != nil {
		in, out := &in.PrimaryDetails, &out.PrimaryDetails
		*out = new(SingleInstanceDatabasePrimaryDetails)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleInstanceDatabaseStandbyConfig.
func (in *SingleInstanceDatabaseStandbyConfig) DeepCopy() *SingleInstanceDatabaseStandbyConfig {
	if in == nil {
		return nil
	}
	out := new(SingleInstanceDatabaseStandbyConfig)
...
func (in *StandbyConfig) DeepCopyInto(out *StandbyConfig) {
	*out = *in
	if in.PrimaryDatabaseRefs != nil {
		in, out := &in.PrimaryDatabaseRefs, &out.PrimaryDatabaseRefs
		*out = make([]PrimaryDatabaseCRRef, len(*in))
		copy(*out, *in)
	}
	if in.PrimaryConnectStrings != nil {
		in, out := &in.PrimaryConnectStrings, &out.PrimaryConnectStrings
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.PrimaryEndpoints != nil {
		in, out := &in.PrimaryEndpoints, &out.PrimaryEndpoints
		*out = make([]PrimaryEndpointRef, len(*in))
		copy(*out, *in)
	}
	if in.TDEWallet != nil {
		in, out := &in.TDEWallet, &out.TDEWallet
