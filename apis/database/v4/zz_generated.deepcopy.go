...
func (in *RacDatabaseSpec) DeepCopyInto(out *RacDatabaseSpec) {
	*out = *in
	if in.InstDetails != nil {
		in, out := &in.InstDetails, &out.InstDetails
		*out = make([]RacInstDetailSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RacInstDetailSpec) DeepCopyInto(out *RacInstDetailSpec) {
	*out = *in
	if in.WorkerNode != nil {
		in, out := &in.WorkerNode, &out.WorkerNode
		*out = make([]string, len(*in))
	...
	if in.LsnrTargetPort != nil {
		in, out := &in.LsnrTargetPort, &out.LsnrTargetPort
		*out = new(int32)
		**out = **in
	}
	if in.OnsLocalPort != nil {
	...
	if in.LsnrLocalPort != nil {
		in, out := &in.LsnrLocalPort, &out.LsnrLocalPort
		*out = new(int32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RacInstDetailSpec.
func (in *RacInstDetailSpec) DeepCopy() *RacInstDetailSpec {
	if in == nil {
		return nil
	}
	out := new(RacInstDetailSpec)
