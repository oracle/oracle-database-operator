...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutonomousDatabaseRestoreDestination) DeepCopyInto(out *AutonomousDatabaseRestoreDestination) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutonomousDatabaseRestoreDestination.
func (in *AutonomousDatabaseRestoreDestination) DeepCopy() *AutonomousDatabaseRestoreDestination {
	if in == nil {
		return nil
	}
	out := new(AutonomousDatabaseRestoreDestination)
	in.DeepCopyInto(out)
	return out
}
