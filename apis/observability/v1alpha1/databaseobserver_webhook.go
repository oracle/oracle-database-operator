...
//+kubebuilder:webhook:path=/mutate-observability-oracle-com-v1alpha1-databaseobserver,mutating=true,sideEffects=none,failurePolicy=fail,matchPolicy=Exact,groups=observability.oracle.com,resources=databaseobservers,verbs=create;update,versions=v1alpha1,name=mdatabaseobserverv1alpha1.kb.io,admissionReviewVersions=v1
...
func (r *DatabaseObserver) Default(_ context.Context, obj *DatabaseObserver) error {
	...
	databaseobserverlog.Info("DatabaseObserver defaulting (webhook v1alpha1)", "name", obj.Name)

	return nil
}

//+kubebuilder:webhook:verbs=create;update,path=/validate-observability-oracle-com-v1alpha1-databaseobserver,mutating=false,sideEffects=none,failurePolicy=fail,matchPolicy=Exact,groups=observability.oracle.com,resources=databaseobservers,versions=v1alpha1,name=vdatabaseobserverv1alpha1.kb.io,admissionReviewVersions=v1
...
func (r *DatabaseObserver) ValidateCreate(_ context.Context, obj *DatabaseObserver) (admission.Warnings, error) {
	databaseobserverlog.Info("DatabaseObserver validate create (webhook v1alpha1)", "name", obj.Name)
...
func (r *DatabaseObserver) ValidateUpdate(_ context.Context, _ *DatabaseObserver, newObj *DatabaseObserver) (admission.Warnings, error) {
	databaseobserverlog.Info("DatabaseObserver validate update (webhook v1alpha1)", "name", newObj.Name)
	var e field.ErrorList
...
func (r *DatabaseObserver) ValidateDelete(_ context.Context, obj *DatabaseObserver) (admission.Warnings, error) {
	databaseobserverlog.Info("DatabaseObserver validate delete (webhook v1alpha1)", "name", obj.Name)
	return nil, nil
}
